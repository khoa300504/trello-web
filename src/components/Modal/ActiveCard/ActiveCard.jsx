...
import { clearAndHideActiveCard, selectCurrentActiveCard, selectIsShowModalActiveCard, updateCurrentActiveCard } from '~/redux/activeCard/activeCardSlice'
...
function ActiveCard() {
  ...
  const onUpdateCardMember = (incommingMemberInfo) => {
