...
function Notifications() {
  ...
  useEffect(() => {
    ...
    //Khi nhan duoc su kien BE_USER_INVITED_TO_BOARD
    const onReceiveNewInvitation = (invitaion) => {
      if (invitaion.inviteeId === currentUser._id) {
        dispatch(addNotification(invitaion))
