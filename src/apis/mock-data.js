export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'KhoaNguyenDev MERN Stack',
    ...
    columns: [
      ...
      },
      {
        ...
        //mỗi column sẽ có 1 placeholder card duy nhất để giữ chỗ và sẽ được ẩn đi bới UI xử lý cho th emptyColumn thì k dragOver đc
        //Cấu trúc Id của card là unique cần đầy đủ _id, boardId, columnId, Fe_PlaceholderCard
        cards: [
          {
