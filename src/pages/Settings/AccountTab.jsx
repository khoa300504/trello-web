...
function AccountTab() {
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    toast.promise(
      ...
      if (!res.error) toast.success('Update complete!')
    })
  }
  ...
  const uploadAvatar = (e) => {
    ...
    // Sử dụng FormData de xu ly dữ liệu liên quan tới file khi gọi API
    ...
    toast.promise(
      ...
      if (!res.error) toast.success('New avatar has been updated!')
      // Luu y du file co loi hay thanh cong, cung phai clear input file, neu khong thi k the chon cung 1 file lien tiep
      e.target.value = ''
    })
  }
